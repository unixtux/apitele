...
# TransactionPartner (5)
DEFAULT_TRANSACTION_PARTNER_AFFILIATE_PROGRAM = 'affiliate_program'
DEFAULT_TRANSACTION_PARTNER_CHAT = 'chat'
...
# OwnedGift (2)
DEFAULT_OWNED_GIFT_REGULAR = 'regular'
DEFAULT_OWNED_GIFT_UNIQUE = 'unique'
...
# InputProfilePhoto(2)
DEFAULT_INPUT_PROFILE_PHOTO_STATIC = 'static'
DEFAULT_INPUT_PROFILE_PHOTO_ANIMATED = 'animated'

# InputStoryContent (2)
DEFAULT_INPUT_STORY_CONTENT_PHOTO = 'photo'
DEFAULT_INPUT_STORY_CONTENT_VIDEO = 'video'

# StoryAreaType (5)
DEFAULT_STORY_AREA_TYPE_LOCATION = 'location'
DEFAULT_STORY_AREA_TYPE_SUGGESTED_REACTION = 'suggested_reaction'
DEFAULT_STORY_AREA_TYPE_LINK = 'link'
DEFAULT_STORY_AREA_TYPE_WEATHER = 'weather'
DEFAULT_STORY_AREA_TYPE_UNIQUE_GIFT = 'unique_gift'
